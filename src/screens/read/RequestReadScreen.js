...
export default function RequestReadScreen({route, navigation}) {
    ...
    return (
        <View key={model.id} style={style.elements}>
            ...
            <Text style={[t.textWhite, t.fontMedium, t.textXl]}>ID проблемы: {model.problemId}</Text>
            <Text style={[t.textWhite, t.fontMedium, t.textXl]}>Комментарий: {model.Commentary}</Text>
        </View>
    );
}
