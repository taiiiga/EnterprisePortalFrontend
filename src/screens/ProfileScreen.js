    ...
    return (
        <ScrollView style={tw`h-full w-full bg-white`}>
            <View style={tw`bg-slate-800 w-full items-center pt-5 pb-5 text-white`}>
                ...
                <Text style={tw`text-white`}>{person.projectName}</Text>
            </View>
            <View style={tw`bg-slate-500 rounded mt-5 p-5`}>
                <Text style={tw`text-lg font-bold`}>Должность: <Text
                    style={tw`text-lg font-light`}>{person.positionName}</Text></Text>
                <Text style={tw`text-lg font-bold`}>Вид работы: <Text
                    style={tw`text-lg font-light`}>{person.workTypeName}</Text></Text>
            </View>
            <View style={tw`bg-slate-500 rounded mt-5 p-5`}>
                <Text style={tw`text-lg font-bold`}>Пол: <Text style={tw`text-lg font-light`}>{person.sex}</Text></Text>
                <Text style={tw`text-lg font-bold`}>День рождение: <Text
                    style={tw`text-lg font-light`}>{person.dateOfBirth}</Text></Text>
            </View>
            <View style={tw`bg-slate-500 rounded mt-5 p-5`}>
                <Text style={tw`text-lg font-bold`}>Мобильный телефон: <Text
                    style={tw`text-lg font-light`}>{person.phone}</Text></Text>
                <Text style={tw`text-lg font-bold`}>E-mail: <Text
                    style={tw`text-lg font-light`}>{person.email}</Text></Text>
                <Text style={tw`text-lg font-bold`}>Telegram: <Text
                    style={tw`text-lg font-light`}>{person.telegram}</Text></Text>
            </View>
